...
export const projects: Project[] = [
  {
    ...
    title: 'ChainCrush',
    type: 'unity',
    description: '10×10 블록 연계 퍼즐 (ChainCrush). 순수 C# Core + Unity Shell 분리 아키텍처, DI 컨테이너, BFS 연쇄 제거, AI 힌트 시스템 (BFS + 전략 분류 + 자연어 생성), Vercel Serverless 리더보드.',
    image: '/images/chaincrush.png',
    technologies: ['Unity 6', 'C#', 'DI Container', 'BFS', 'AI Hint System', 'SOLID Principles', 'Vercel Serverless', 'Neon PostgreSQL'],
