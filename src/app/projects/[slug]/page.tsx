  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0D0D0E]">
      <article className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* Header */}
        <header className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1F2937] rounded-xl p-6 mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-[#E5E7EB] mb-3">
            {project.title}
          </h1>
          ...
          <div className="flex flex-wrap gap-2">
            {project.technologies.map((tech) => (
              <span
                key={tech}
                className="text-xs px-2.5 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-[#9CA3AF] border border-gray-200 dark:border-[#1F2937]"
              >
                {tech}
              </span>
            ))}
        ...
        {/* Detail Content */}
        <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1F2937] rounded-xl p-6 mb-6 prose dark:prose-invert max-w-none">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-[#E5E7EB] mb-4">
            Project Details
          </h2>
          <div className="space-y-6 text-gray-600 dark:text-[#9CA3AF] text-sm leading-relaxed">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          {project.github && (
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-semibold text-sm rounded-lg transition-colors"
            >
          ...
          {project.demo && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#22D3EE] hover:bg-[#06B6D4] text-[#0D0D0E] font-semibold text-sm rounded-lg transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {project.hasPlayableDemo && project.demo && (
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold text-sm rounded-lg transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
